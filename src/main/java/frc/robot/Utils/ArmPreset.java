...
public enum ArmPreset {
    Zero(new ArmConfiguration(JointType.Shoulder.initialValue+7.5, Units.inchesToMeters(23.499999459334248+0.5), JointType.Wrist.initialValue-15)),
    ...
    BargeAlgae(new ArmConfiguration(90, Units.inchesToMeters(51), -10)),
