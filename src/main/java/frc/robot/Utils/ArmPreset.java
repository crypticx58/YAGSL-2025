...
public enum ArmPreset {
    Zero(new ArmConfiguration(JointType.Shoulder.initialValue+5, Units.inchesToMeters(23.499999459334248+0.5), JointType.Wrist.initialValue-30)),
    ...
    LowAlgae(new ArmConfiguration(45.696929931640625+5, Units.inchesToMeters(28.515009898839036), -17.82908058166504)),
    HighAlgae(new ArmConfiguration(61.50768280029297+1, Units.inchesToMeters(41.94723339531365+1.5), -39.429046630859375)),
    Processor(new ArmConfiguration(0.5, Units.inchesToMeters(23.499999459334248), 41.82804489135742+5)),
    StartingAlgae(new ArmConfiguration(33.186, Units.inchesToMeters(23.499999459334248), -40.114+10)),
    //SlingshotAlgae(new ArmConfiguration(70, Units.inchesToMeters(51), 0)),
