...
public class GoToProcessorBasedOnPoseEstimation extends Command {
  SwerveSubsystem  swerveSubsystem = SwerveSubsystem.getInstance();
  ArmSubsystem armSubsystem = ArmSubsystem.getInstance();
  VisionSubsystem visionSubsystem = VisionSubsystem.getInstance();
  Pose3d ProcessorPose;
  ...
  public GoToProcessorBasedOnPoseEstimation(boolean offsetScroingDistance) {
  ...
  public void initialize() {
    ProcessorPose = visionSubsystem.getProcessorId();
    swervePoseSetpoint = ProcessorPose.plus(
      new Transform3d(
        new Translation3d(offsetScroingDistance ? ArmConstants.OffsetProcessorScoringDistance: ArmConstants.ProcessorScoringDistance, 0,0),
